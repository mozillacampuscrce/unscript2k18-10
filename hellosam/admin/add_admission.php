...
<a href='http://localhost/hellosam/login/signup.php?user_role=parent&s_email=".$p_email."&s_rollno=-1'>http://localhost/hellosam/login/signup.php?user_role=parent&s_email=".$p_email."&s_rollno=-1</a>
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'perfecttreatco@gmail.com';
            $mail->Password = 'perfectskrj';
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            ...
            $mail->setFrom('perfecttreatco@gmail.com', 'Email Verification');
            $mail->addAddress($email_address, 'Email Verification');
            $mail->addReplyTo('perfecttreatco@gmail.com', 'Email Verification');
            $mail->isHTML(true);
        ...
        try {
            ...
            $mail1->SMTPAuth = true;
            $mail1->Username = 'perfecttreatco@gmail.com';
            $mail1->Password = 'perfectskrj';
            ...
            $mail1->setFrom('perfecttreatco@gmail.com', 'Email Verification');
            $mail1->addAddress($email_address1, 'Email Verification');
            $mail1->addReplyTo('perfecttreatco@gmail.com', 'Email Verification');
            $mail1->isHTML(true);
